    ...
    return (
        ...
        >
            ...
            {loading ? (
                ...
                <div
                    className="text-center text-muted py-5 bg-surface border rounded"
                    ...
                    {orders.map((order) => (
                        ...
                        >
                            ...
                            {order.status !== "returned" && (
                                <div
                                    className="d-flex justify-between align-center my-4 py-2 relative"
                                ...
                                >
                                    ...
                                    />
                                    {getTrackerSteps(order.status).map(
                                        (state, idx) => (
                                            <div
                                                key={idx}
                                                style={{
                            ...
                            {order.delivery &&
                                order.delivery.status ===
                                    ...
                                    <div className="bg-amber-light p-3 text-amber-dark text-sm rounded mb-3 flex align-center gap-2">
                                        <span>🛵</span> Your rider{" "}
                                        <b>{order.delivery.rider?.name}</b> is
                                        on the way! ETA: ~30 mins.
                                    </div>
                                )}

                            <div>
                                <h4 className="text-sm font-bold text-muted mb-2 text-uppercase">
                                    Items
                                </h4>
                                {order.items?.map((i) => (
